...
const Home = () => {
  ...
  const handleBuyNow = (product) => {
    // Keep direct buy for specific products
    const productObj = {
      _id: product.id || Date.now(),
      name: product.name,
      price: product.price,
      image: product.image,
      category: 'Festive'
        ...
        <div className="carousel-inner">
          <div className="carousel-item active" data-bs-interval={10000}>
            ...
            <div className="carousel-caption d-none d-md-block">
              <Fade top>
                <h1 className='homeimg3ds fs-9 p-3 mb-5 pb-0' style={{ fontSize: '60px' }}>Free Shipping </h1>
          ...
          <div className="carousel-item" data-bs-interval={2000}>
            ...
            <div className="carousel-caption d-none d-md-block">
              <Fade top >
                <button className='btn btn-warning rounded-0 border border-dark homeimg3ds mb-5 p-3 fs-4' onClick={() => handleShopNow('Brass')}>Shop The Collection</button>
              </Fade>
            </div>
          </div>
          ...
          <div className="carousel-item" data-bs-interval={5000}>
            ...
            <div className="carousel-caption d-none d-md-block">
              <Fade top >
                <h5 className='homeimg3ds fs-9 p-3' style={{ fontSize: '60px' }}>Wall Accents</h5>
                <p className='homeimg3ds mb-5 ' style={{ marginBottom: '30rem' }}>Some representative placeholder content for the first slide.</p>
                <button className='btn btn-warning border border-dark rounded-0 homeimg3ds mb-5 fs-5' onClick={() => handleShopNow('Wall Decor')}>Shop The Collection</button>
              </Fade>
            </div>
          </div>
              ...
              <div className='card-body rounded-5 homeimg1 '>
                <div className='homeimg2ds'>
                  <Fade bottom>
                    ...
                    <button className='btn btn-warning border border-white   mb-5 rounded-0 ' onClick={() => handleShopNow('Brass')}>Shop Now</button>
                  </Fade>
              ...
              <div className='card-body rounded-5  homeimg2 '>
                <div className='homeimg2ds'>
                  <Fade bottom>
                    <h4>Copper</h4>
                    <p className='text-white'>Add elegance and charm to <br /> your home with these <br /> beautiful masterpieces</p>
                    <button className='btn btn-warning border border-white mb-5  rounded-0 mb-5 ' onClick={() => handleShopNow('Copper')}>Shop Now</button>
                  </Fade>
          ...
          <div className='col-md-4 p-5 justify-content-evenly justify-content-center'>
            <div className='card border-0' >
              ...
              <div className='card-body cardbg p-3  '>
                <Fade bottom>
                  <h3>Ajrakh</h3>
                  <p> With origins from thousands of years ago, Ajrakh hails from the desert regions of Kutch, Gujarat.</p>
                  <button className='btn btn-warning border-white mt-3 rounded-0' onClick={() => handleShopNow('Ajrakh')}>Shop Now</button>
                </Fade>
          ...
          <div className='col-md-4 p-5 justify-content-evenly justify-content-center'>
            <div className='card border-0'>
              ...
              <div className='card-body cardbg p-3 '>
                <Fade bottom>
                  <h3>Kalamkari</h3>
                  <p> Kalamkari’ is an ancient style of hand painting. The term Kalamkari comes from the words ‘kalam’ meaning pen.</p>
                  <button className='btn btn-warning border-white mt-3 rounded-0' onClick={() => handleShopNow('Kalamkari')}>Shop Now</button>
                </Fade>
          ...
          <div className='col-md-4 p-5 justify-content-evenly justify-content-center'>
            <div className='card border-0'>
              ...
              <div className='card-body cardbg  p-3 '>
                <Fade bottom>
                  <h3 >Sui Dhaga</h3>
                  <p> Sui Dhaaga is a representation of different embroideries of India, like Kantha, Aari and Sheesha.</p>
                  <button className='btn btn-warning border-white mt-3 rounded-0' onClick={() => handleShopNow('Sui Dhaga')}> Shop Now</button>
                </Fade>
            ...
            <div className='card border-0' >
              ...
              <div className='card-body cardbg p-3  '>
                <Fade bottom>
                  ...
                  <p>Rs450</p>
                  <button className='btn btn-warning border-white mt-3 rounded-3' onClick={() => handleBuyNow({ name: 'Brass BookMark Peacock', price: 450, image: 'https://thebombaystore.com/cdn/shop/products/TBS13795_2_500x.jpg?v=1634206681' })}>Buy Now</button>
                </Fade>
            ...
            <div className='card border-0'>
              ...
              <div className='card-body cardbg p-3 '>
                <Fade bottom>
                  ...
                  <p>Rs1145</p>
                  <button className='btn btn-warning border-white mt-3 rounded-3' onClick={() => handleBuyNow({ name: 'Kanmani Triball Doll', price: 1145, image: 'https://thebombaystore.com/cdn/shop/products/20221123_142146_500x.jpg?v=1669379050' })}>Buy Now</button>
                </Fade>
            ...
            <div className='card border-0 '>
              ...
              <div className='card-body cardbg   p-3 '>
                <Fade bottom>
                  ...
                  <p>Rs1950</p>
                  <button className='btn btn-warning border-white mt-3 rounded-3' onClick={() => handleBuyNow({ name: 'Iron Music Design', price: 1950, image: 'https://thebombaystore.com/cdn/shop/products/001_25e65e8b-a10d-4c40-b664-95cd80cb2e2b_500x.jpg?v=1646042732' })}> Buy Now</button>
                </Fade>
          ...
          <div className='col-md-4 p-5 justify-content-evenly justify-content-center'>
            <div className='card border-0' >
              ...
              <div className='card-body cardbg p-3  '>
                <Fade bottom>
                  <h4>Below Rs500</h4>
                  <button className='btn btn-warning border-white mt-3 rounded-0 text-white fs-7' style={{ backgroundColor: 'orange' }} onClick={() => navigate('/browse?maxPrice=500')}>Shop Now</button>
                </Fade>
